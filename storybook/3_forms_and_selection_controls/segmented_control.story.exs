defmodule Storybook.MoonUIComponents.SegmentedControl do
  @moduledoc false
  use PhoenixStorybook.Story, :component

  def function, do: &MoonUI.SegmentedControl.segmented_control/1

  def imports,
    do: [{MoonUI.SegmentedControl, segmented_control_item: 1}, {MoonUI.Icon, [icon: 1]}]
