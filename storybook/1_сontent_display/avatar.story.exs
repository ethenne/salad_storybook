defmodule Storybook.MoonUIComponents.Avatar do
  @moduledoc false
  use PhoenixStorybook.Story, :component

  alias MoonUI.Avatar

  def function, do: &MoonUI.Avatar.avatar/1

  def imports, do: [{Avatar, [avatar_image: 1, avatar_fallback: 1]}, {MoonUI.Icon, [icon: 1]}]
